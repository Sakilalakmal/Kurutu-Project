...
export function DataTableNode({ id, data, selected }: NodeProps<EditorFlowNode>) {
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-xl border bg-white shadow-[0_16px_36px_-28px_rgba(15,23,42,0.7)] transition-all duration-200",
